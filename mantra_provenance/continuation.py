...
def capture_training_continuation(
    optimizer: Optimizer,
    dataloader: StatefulDataLoader,
    numpy_generators: Mapping[str, np.random.Generator],
    *,
...
def restore_training_continuation(
...
def save_training_continuation(
    path: Path,
    continuation: TrainingContinuationState,
) -> None:
...
def load_training_continuation(path: Path) -> TrainingContinuationState:
    ...
    return TrainingContinuationState.model_validate(loaded)
